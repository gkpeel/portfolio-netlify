...
import PupWalk from '../../img/projects/philly-leashes-of-valor.png';
import ExitStrategyRetreat from '../../img/projects/exit-strategy-retreat.png';
		...
		return (
			<Section>
				...
				<Row className="mb-3 mb-lg-5">
					<Col xs={true} lg={{ span: 8, offset: 2 }} xl={{ span: 6, offset: 3 }}>
						<ContentBox>
							...
							<CtaButton to="/contact" icon="user-circle">
								Contact Me
							</CtaButton>
						</ContentBox>
					</Col>
				...
				<Row className="row-eq-height">
					<ProjectCard image={PupWalk} link="https://philly.leashesofvalor.org/">
						<ContentSubHeader>PupWalk4LOV</ContentSubHeader>
						<ListGroup>
							<li>Custom Wordpress Theme</li>
							<li>Uses GiveWP, Stripe, and Caldera Forms plugins to create a Peer-to-Peer non-profit platform</li>
							<li>Has been integral in helping raise funds for the Leashes of Valor organization</li>
						</ListGroup>
					</ProjectCard>
					<ProjectCard image={ExitStrategyRetreat} link="https://exitstrategyretreat.com/">
						<ContentSubHeader>Exit Strategy Retreat</ContentSubHeader>
						<ListGroup>
							<li>Custom Wordpress Theme</li>
							<li>Bootstrap 4 Framework</li>
							<li>Leverages Zapier and Mailchimp automations to create an enjoyable and immediate onboarding path</li>
						</ListGroup>
					</ProjectCard>
					<ProjectCard image={QuizMap} link="https://quizmap.herokuapp.com/" repo="https://github.com/gkpeel/quiZMap-react">
						...
						<ListGroup>
							...
							<li>
								<em>Future Refactoring: Redux Implementation</em>
							</li>
						</ListGroup>
					</ProjectCard>
