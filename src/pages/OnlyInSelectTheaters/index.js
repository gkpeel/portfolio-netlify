...
import Script from '../../pdf/only-in-select-theaters.pdf';
	...
	render() {
		return (
			<Section>
				<Row>
					<Col xs="12">
						<ContentHeader>Only in Select Theaters</ContentHeader>
					</Col>
					<Col xs={{ span: '12', order: '3' }} lg={{ span: '10', offset: '1', order: '2' }} xl={{ span: '8', offset: '2' }}>
						<embed src={Script} type="application/pdf" width="100%" height="793" />
					</Col>
					<Col xs={{ span: '12', order: '2' }} lg={{ span: '10', offset: '1', order: '3' }} xl={{ span: '8', offset: '2' }}>
						<DownloadButton href={Script} download>
							Download Oist <FontAwesomeIcon className="cta-icon" icon="file-download" />
						</DownloadButton>
					</Col>
				</Row>
			</Section>
