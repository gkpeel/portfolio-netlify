    ...
    return (
        <Section>
            <Row>
                ...
                >
                    <ContentBox>
                        <h3 style={{ marginBottom: "1rem" }}>Want to say hello or reach out to work together on a project?</h3>
                        <h4 style={{ color: "#777", marginBottom: "3rem" }}><em>(Contact From Submissions coming soon)</em></h4>
                        <Row>
                            <Col
                                xs="12"
                                lg="6"
